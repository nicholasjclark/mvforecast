#' NEON Amblyomma tick abundance surveys used in the 2021 EFI forecasting challenge
#'
#' A dataset containing interpolated timeseries of Amblyomma americanum nymph abundances at NEON sites. All plot
#' series were truncated so that their start dates were identical. They were then interpolated using na.interp in the
#' forecast package and split into training and testing sets. The same was then done for regressors
#'
...
#'   \item{y_train}{xts matrix containing the interpolated in-sample observations}
