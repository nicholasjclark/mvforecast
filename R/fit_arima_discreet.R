#'Fit an auto.arima() model to a logged version of a discrete time series
#'
#'This function fits an auto.arima() model to a discrete time series that has been interpolated
...
#'@export
#'
fit_arima_discreet = function(y, frequency, horizon){
